...
A video that demonstrates the tools that work with domain specific patterns created with SHACL can be found online. Additionally, you can register to [semantify.it](https://semantify.it) and try everything yourself.
